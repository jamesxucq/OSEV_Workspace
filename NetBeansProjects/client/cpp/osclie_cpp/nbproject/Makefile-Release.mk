...
${OBJECTDIR}/OSEVConne.o: OSEVConne.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSEVConne.o OSEVConne.cpp

${OBJECTDIR}/OSEVContain.o: OSEVContain.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSEVContain.o OSEVContain.cpp

${OBJECTDIR}/OSVBase.o: OSVBase.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSVBase.o OSVBase.cpp

${OBJECTDIR}/clie_bzl.o: clie_bzl.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/clie_bzl.o clie_bzl.c

${OBJECTDIR}/clie_obje.o: clie_obje.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/clie_obje.o clie_obje.c

${OBJECTDIR}/excep_msg.o: excep_msg.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/excep_msg.o excep_msg.c

${OBJECTDIR}/hand_method.o: hand_method.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hand_method.o hand_method.c

${OBJECTDIR}/osco_socks.o: osco_socks.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/osco_socks.o osco_socks.c

${OBJECTDIR}/osev_clie_cpp.o: osev_clie_cpp.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/osev_clie_cpp.o osev_clie_cpp.cpp

${OBJECTDIR}/osev_common/action_hmap.o: osev_common/action_hmap.c
	${MKDIR} -p ${OBJECTDIR}/osev_common
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/osev_common/action_hmap.o osev_common/action_hmap.c

${OBJECTDIR}/osev_common/checksum.o: osev_common/checksum.c
	${MKDIR} -p ${OBJECTDIR}/osev_common
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/osev_common/checksum.o osev_common/checksum.c

${OBJECTDIR}/osev_common/encoding.o: osev_common/encoding.c
	${MKDIR} -p ${OBJECTDIR}/osev_common
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/osev_common/encoding.o osev_common/encoding.c

${OBJECTDIR}/osev_common/hash_table_ex.o: osev_common/hash_table_ex.c
	${MKDIR} -p ${OBJECTDIR}/osev_common
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/osev_common/hash_table_ex.o osev_common/hash_table_ex.c

${OBJECTDIR}/osev_common/linux_os.o: osev_common/linux_os.c
	${MKDIR} -p ${OBJECTDIR}/osev_common
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/osev_common/linux_os.o osev_common/linux_os.c

${OBJECTDIR}/osev_common/md5.o: osev_common/md5.c
	${MKDIR} -p ${OBJECTDIR}/osev_common
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/osev_common/md5.o osev_common/md5.c

${OBJECTDIR}/osev_common/oid.o: osev_common/oid.c
	${MKDIR} -p ${OBJECTDIR}/osev_common
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/osev_common/oid.o osev_common/oid.c

${OBJECTDIR}/osev_common/paras_style.o: osev_common/paras_style.c
	${MKDIR} -p ${OBJECTDIR}/osev_common
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/osev_common/paras_style.o osev_common/paras_style.c

${OBJECTDIR}/osev_common/string_utility.o: osev_common/string_utility.c
	${MKDIR} -p ${OBJECTDIR}/osev_common
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/osev_common/string_utility.o osev_common/string_utility.c

${OBJECTDIR}/pinvo.o: pinvo.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pinvo.o pinvo.c

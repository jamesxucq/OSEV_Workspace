...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/osev_shell: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/osev_shell ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/builtin_command.o: builtin_command.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/builtin_command.o builtin_command.c

${OBJECTDIR}/check_command.o: check_command.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/check_command.o check_command.c

${OBJECTDIR}/clie_obje.o: clie_obje.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/clie_obje.o clie_obje.c

${OBJECTDIR}/connect.o: connect.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/connect.o connect.c

${OBJECTDIR}/conv_echo.o: conv_echo.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conv_echo.o conv_echo.c

${OBJECTDIR}/conv_utili.o: conv_utili.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conv_utili.o conv_utili.c

${OBJECTDIR}/conve_command.o: conve_command.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conve_command.o conve_command.c

${OBJECTDIR}/defau_utili.o: defau_utili.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/defau_utili.o defau_utili.c
...
${OBJECTDIR}/extend.o: extend.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend.o extend.c

${OBJECTDIR}/extend/conve.o: extend/conve.c
	${MKDIR} -p ${OBJECTDIR}/extend
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve.o extend/conve.c

${OBJECTDIR}/extend/conve_lang/clas_list.o: extend/conve_lang/clas_list.c
	${MKDIR} -p ${OBJECTDIR}/extend/conve_lang
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/clas_list.o extend/conve_lang/clas_list.c

${OBJECTDIR}/extend/conve_lang/conv_gcc_cpp.o: extend/conve_lang/conv_gcc_cpp.c
	${MKDIR} -p ${OBJECTDIR}/extend/conve_lang
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/conv_gcc_cpp.o extend/conve_lang/conv_gcc_cpp.c

${OBJECTDIR}/extend/conve_lang/conv_stri.o: extend/conve_lang/conv_stri.c
	${MKDIR} -p ${OBJECTDIR}/extend/conve_lang
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/conv_stri.o extend/conve_lang/conv_stri.c

${OBJECTDIR}/extend/conve_lang/conv_utili.o: extend/conve_lang/conv_utili.c
	${MKDIR} -p ${OBJECTDIR}/extend/conve_lang
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/conv_utili.o extend/conve_lang/conv_utili.c

${OBJECTDIR}/extend/conve_lang/conver.o: extend/conve_lang/conver.c
	${MKDIR} -p ${OBJECTDIR}/extend/conve_lang
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/conver.o extend/conve_lang/conver.c

${OBJECTDIR}/extend/conve_lang/elang.o: extend/conve_lang/elang.c
	${MKDIR} -p ${OBJECTDIR}/extend/conve_lang
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/elang.o extend/conve_lang/elang.c

${OBJECTDIR}/extend/conve_lang/load_conte.o: extend/conve_lang/load_conte.c
	${MKDIR} -p ${OBJECTDIR}/extend/conve_lang
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/load_conte.o extend/conve_lang/load_conte.c

${OBJECTDIR}/extend/conve_lang/pars_utili.o: extend/conve_lang/pars_utili.c
	${MKDIR} -p ${OBJECTDIR}/extend/conve_lang
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/pars_utili.o extend/conve_lang/pars_utili.c

${OBJECTDIR}/extend/conve_lang/parse.o: extend/conve_lang/parse.c
	${MKDIR} -p ${OBJECTDIR}/extend/conve_lang
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/parse.o extend/conve_lang/parse.c

${OBJECTDIR}/extend/conve_lang/pcattr.o: extend/conve_lang/pcattr.c
	${MKDIR} -p ${OBJECTDIR}/extend/conve_lang
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/pcattr.o extend/conve_lang/pcattr.c

${OBJECTDIR}/extend/list.o: extend/list.c
	${MKDIR} -p ${OBJECTDIR}/extend
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/list.o extend/list.c

${OBJECTDIR}/extend/load.o: extend/load.c
	${MKDIR} -p ${OBJECTDIR}/extend
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/load.o extend/load.c

${OBJECTDIR}/extend/parse_echo/epcla.o: extend/parse_echo/epcla.c
	${MKDIR} -p ${OBJECTDIR}/extend/parse_echo
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/parse_echo/epcla.o extend/parse_echo/epcla.c

${OBJECTDIR}/extend/pretty.o: extend/pretty.c
	${MKDIR} -p ${OBJECTDIR}/extend
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/pretty.o extend/pretty.c

${OBJECTDIR}/extend/save.o: extend/save.c
	${MKDIR} -p ${OBJECTDIR}/extend
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/save.o extend/save.c

${OBJECTDIR}/extend/struti.o: extend/struti.c
	${MKDIR} -p ${OBJECTDIR}/extend
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/struti.o extend/struti.c

${OBJECTDIR}/method.o: method.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/method.o method.c
...
${OBJECTDIR}/osev_shell.o: osev_shell.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/osev_shell.o osev_shell.c

${OBJECTDIR}/parse_command.o: parse_command.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parse_command.o parse_command.c

${OBJECTDIR}/parsing.o: parsing.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parsing.o parsing.c

${OBJECTDIR}/prepa_check.o: prepa_check.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/prepa_check.o prepa_check.c

${OBJECTDIR}/prepa_prompt.o: prepa_prompt.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/prepa_prompt.o prepa_prompt.c

${OBJECTDIR}/shel_struct.o: shel_struct.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/shel_struct.o shel_struct.c

${OBJECTDIR}/stri_utili.o: stri_utili.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stri_utili.o stri_utili.c
...
${TESTDIR}/tests/modetest.o: tests/modetest.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/modetest.o tests/modetest.c


${TESTDIR}/tests/objetest.o: tests/objetest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/objetest.o tests/objetest.c
...
${OBJECTDIR}/_ext/d8a3b606/hash_table_ex_nomain.o: ${OBJECTDIR}/_ext/d8a3b606/hash_table_ex.o ../osev_common/hash_table_ex.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d8a3b606/hash_table_ex_nomain.o ../osev_common/hash_table_ex.c;\
	else  \
...
${OBJECTDIR}/_ext/d8a3b606/stri_utili_nomain.o: ${OBJECTDIR}/_ext/d8a3b606/stri_utili.o ../osev_common/stri_utili.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d8a3b606/stri_utili_nomain.o ../osev_common/stri_utili.c;\
	else  \
...
${OBJECTDIR}/_ext/b1a51e63/action_hmap_nomain.o: ${OBJECTDIR}/_ext/b1a51e63/action_hmap.o ../osev_common/utility/action_hmap.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b1a51e63/action_hmap_nomain.o ../osev_common/utility/action_hmap.c;\
	else  \
...
${OBJECTDIR}/_ext/f534dc3f/binary_logger_nomain.o: ${OBJECTDIR}/_ext/f534dc3f/binary_logger.o ../third_party/binary_logger.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f534dc3f/binary_logger_nomain.o ../third_party/binary_logger.c;\
	else  \
...
${OBJECTDIR}/builtin_command_nomain.o: ${OBJECTDIR}/builtin_command.o builtin_command.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/builtin_command_nomain.o builtin_command.c;\
	else  \
...
${OBJECTDIR}/check_command_nomain.o: ${OBJECTDIR}/check_command.o check_command.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/check_command_nomain.o check_command.c;\
	else  \
...
${OBJECTDIR}/clie_obje_nomain.o: ${OBJECTDIR}/clie_obje.o clie_obje.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/clie_obje_nomain.o clie_obje.c;\
	else  \
...
${OBJECTDIR}/connect_nomain.o: ${OBJECTDIR}/connect.o connect.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/connect_nomain.o connect.c;\
	else  \
...
${OBJECTDIR}/conv_echo_nomain.o: ${OBJECTDIR}/conv_echo.o conv_echo.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conv_echo_nomain.o conv_echo.c;\
	else  \
...
${OBJECTDIR}/conv_utili_nomain.o: ${OBJECTDIR}/conv_utili.o conv_utili.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conv_utili_nomain.o conv_utili.c;\
	else  \
...
${OBJECTDIR}/conve_command_nomain.o: ${OBJECTDIR}/conve_command.o conve_command.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/conve_command_nomain.o conve_command.c;\
	else  \
...
${OBJECTDIR}/defau_utili_nomain.o: ${OBJECTDIR}/defau_utili.o defau_utili.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/defau_utili_nomain.o defau_utili.c;\
	else  \
...
${OBJECTDIR}/extend_nomain.o: ${OBJECTDIR}/extend.o extend.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend_nomain.o extend.c;\
	else  \
...
${OBJECTDIR}/extend/conve_nomain.o: ${OBJECTDIR}/extend/conve.o extend/conve.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_nomain.o extend/conve.c;\
	else  \
...
${OBJECTDIR}/extend/conve_lang/clas_list_nomain.o: ${OBJECTDIR}/extend/conve_lang/clas_list.o extend/conve_lang/clas_list.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/clas_list_nomain.o extend/conve_lang/clas_list.c;\
	else  \
...
${OBJECTDIR}/extend/conve_lang/conv_gcc_cpp_nomain.o: ${OBJECTDIR}/extend/conve_lang/conv_gcc_cpp.o extend/conve_lang/conv_gcc_cpp.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/conv_gcc_cpp_nomain.o extend/conve_lang/conv_gcc_cpp.c;\
	else  \
...
${OBJECTDIR}/extend/conve_lang/conv_stri_nomain.o: ${OBJECTDIR}/extend/conve_lang/conv_stri.o extend/conve_lang/conv_stri.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/conv_stri_nomain.o extend/conve_lang/conv_stri.c;\
	else  \
...
${OBJECTDIR}/extend/conve_lang/conv_utili_nomain.o: ${OBJECTDIR}/extend/conve_lang/conv_utili.o extend/conve_lang/conv_utili.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/conv_utili_nomain.o extend/conve_lang/conv_utili.c;\
	else  \
...
${OBJECTDIR}/extend/conve_lang/conver_nomain.o: ${OBJECTDIR}/extend/conve_lang/conver.o extend/conve_lang/conver.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/conver_nomain.o extend/conve_lang/conver.c;\
	else  \
...
${OBJECTDIR}/extend/conve_lang/elang_nomain.o: ${OBJECTDIR}/extend/conve_lang/elang.o extend/conve_lang/elang.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/elang_nomain.o extend/conve_lang/elang.c;\
	else  \
...
${OBJECTDIR}/extend/conve_lang/load_conte_nomain.o: ${OBJECTDIR}/extend/conve_lang/load_conte.o extend/conve_lang/load_conte.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/load_conte_nomain.o extend/conve_lang/load_conte.c;\
	else  \
...
${OBJECTDIR}/extend/conve_lang/pars_utili_nomain.o: ${OBJECTDIR}/extend/conve_lang/pars_utili.o extend/conve_lang/pars_utili.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/pars_utili_nomain.o extend/conve_lang/pars_utili.c;\
	else  \
...
${OBJECTDIR}/extend/conve_lang/parse_nomain.o: ${OBJECTDIR}/extend/conve_lang/parse.o extend/conve_lang/parse.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/parse_nomain.o extend/conve_lang/parse.c;\
	else  \
...
${OBJECTDIR}/extend/conve_lang/pcattr_nomain.o: ${OBJECTDIR}/extend/conve_lang/pcattr.o extend/conve_lang/pcattr.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/conve_lang/pcattr_nomain.o extend/conve_lang/pcattr.c;\
	else  \
...
${OBJECTDIR}/extend/list_nomain.o: ${OBJECTDIR}/extend/list.o extend/list.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/list_nomain.o extend/list.c;\
	else  \
...
${OBJECTDIR}/extend/load_nomain.o: ${OBJECTDIR}/extend/load.o extend/load.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/load_nomain.o extend/load.c;\
	else  \
...
${OBJECTDIR}/extend/parse_echo/epcla_nomain.o: ${OBJECTDIR}/extend/parse_echo/epcla.o extend/parse_echo/epcla.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/parse_echo/epcla_nomain.o extend/parse_echo/epcla.c;\
	else  \
...
${OBJECTDIR}/extend/pretty_nomain.o: ${OBJECTDIR}/extend/pretty.o extend/pretty.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/pretty_nomain.o extend/pretty.c;\
	else  \
...
${OBJECTDIR}/extend/save_nomain.o: ${OBJECTDIR}/extend/save.o extend/save.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/save_nomain.o extend/save.c;\
	else  \
...
${OBJECTDIR}/extend/struti_nomain.o: ${OBJECTDIR}/extend/struti.o extend/struti.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extend/struti_nomain.o extend/struti.c;\
	else  \
...
${OBJECTDIR}/method_nomain.o: ${OBJECTDIR}/method.o method.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/method_nomain.o method.c;\
	else  \
...
${OBJECTDIR}/options_nomain.o: ${OBJECTDIR}/options.o options.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/options_nomain.o options.c;\
	else  \
...
${OBJECTDIR}/osev_bzl_nomain.o: ${OBJECTDIR}/osev_bzl.o osev_bzl.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/osev_bzl_nomain.o osev_bzl.c;\
	else  \
...
${OBJECTDIR}/osev_shell_nomain.o: ${OBJECTDIR}/osev_shell.o osev_shell.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/osev_shell_nomain.o osev_shell.c;\
	else  \
...
${OBJECTDIR}/parse_command_nomain.o: ${OBJECTDIR}/parse_command.o parse_command.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parse_command_nomain.o parse_command.c;\
	else  \
...
${OBJECTDIR}/parsing_nomain.o: ${OBJECTDIR}/parsing.o parsing.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parsing_nomain.o parsing.c;\
	else  \
...
${OBJECTDIR}/prepa_check_nomain.o: ${OBJECTDIR}/prepa_check.o prepa_check.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/prepa_check_nomain.o prepa_check.c;\
	else  \
...
${OBJECTDIR}/prepa_prompt_nomain.o: ${OBJECTDIR}/prepa_prompt.o prepa_prompt.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/prepa_prompt_nomain.o prepa_prompt.c;\
	else  \
...
${OBJECTDIR}/shel_struct_nomain.o: ${OBJECTDIR}/shel_struct.o shel_struct.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/shel_struct_nomain.o shel_struct.c;\
	else  \
...
${OBJECTDIR}/stri_utili_nomain.o: ${OBJECTDIR}/stri_utili.o stri_utili.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stri_utili_nomain.o stri_utili.c;\
	else  \

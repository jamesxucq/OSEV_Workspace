...
${OBJECTDIR}/creat_shape.o: creat_shape.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/creat_shape.o creat_shape.c

${OBJECTDIR}/sha_sutil.o: sha_sutil.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sha_sutil.o sha_sutil.c

${OBJECTDIR}/shap_cache.o: shap_cache.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/shap_cache.o shap_cache.c

${OBJECTDIR}/shap_entry.o: shap_entry.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/shap_entry.o shap_entry.c

${OBJECTDIR}/shap_utility.o: shap_utility.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/shap_utility.o shap_utility.c

${OBJECTDIR}/shape.o: shape.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/shape.o shape.c

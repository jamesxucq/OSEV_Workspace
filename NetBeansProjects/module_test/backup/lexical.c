...
#define MAX_TOKE_SIZE 512
    ...
    //
    oper_node *new_leaf_node(/*leaf_node B, int c, leaf_node *d*/) {
...
#define ParseTOKENTYPE  leaf_node 
typedef union {
  int yyinit;
  ParseTOKENTYPE yy0;
  oper_node yy12;
...
#line 902 "lexical.c"
      ...
      case 1: /* expr ::= INTEGER */
#line 86 "lexical.y"
{ yylhsminor.yy12 = new_leaf_node(/*yymsp[0].minor.yy0, yymsp[0].major, &yymsp[0].minor.yy0*/);}
#line 907 "lexical.c"
...
#line 88 "lexical.y"
    ...
    leaf_node opno;
      ...
      Parse(pParser, TK_INTEGER, opno);
      Parse(pParser, TK_PLUS   , opno);
      Parse(pParser, TK_INTEGER, opno);
      Parse(pParser, 0, 0);
